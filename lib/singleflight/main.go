// singleflight 库: https://pkg.go.dev/golang.org/x/sync/singleflight
// 源代码摘抄自：https://cs.opensource.google/go/x/sync/+/036812b2:singleflight/singleflight.go
...
// 在 docall 完成前 delete key，会加大对同一下游的并发访问
